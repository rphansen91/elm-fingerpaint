...
/******/ 	__webpack_require__.p = "elm-fingerpaint/dist/";
/******/
...
var _mpizenberg$elm_mouse_events$Mouse$movementDecoder = A3(
	_elm_lang$core$Json_Decode$map2,
	F2(
		function (v0, v1) {
			return {ctor: '_Tuple2', _0: v0, _1: v1};
		}),
	A2(_elm_lang$core$Json_Decode$field, 'movementX', _elm_lang$core$Json_Decode$float),
	A2(_elm_lang$core$Json_Decode$field, 'movementY', _elm_lang$core$Json_Decode$float));
...
var _mpizenberg$elm_mouse_events$Mouse$Event = F4(
	function (a, b, c, d) {
		return {key: a, clientPos: b, offsetPos: c, movement: d};
	});
...
var _mpizenberg$elm_mouse_events$Mouse$eventDecoder = A5(_elm_lang$core$Json_Decode$map4, _mpizenberg$elm_mouse_events$Mouse$Event, _mpizenberg$elm_mouse_events$Mouse$keyDecoder, _mpizenberg$elm_mouse_events$Mouse$clientPosDecoder, _mpizenberg$elm_mouse_events$Mouse$offsetPosDecoder, _mpizenberg$elm_mouse_events$Mouse$movementDecoder);
var _mpizenberg$elm_mouse_events$Mouse$onDown = function (tag) {
	return A3(
		_elm_lang$html$Html_Events$onWithOptions,
		'mousedown',
		_mpizenberg$elm_mouse_events$Mouse$stopOptions,
		A2(_elm_lang$core$Json_Decode$map, tag, _mpizenberg$elm_mouse_events$Mouse$eventDecoder));
};
var _mpizenberg$elm_mouse_events$Mouse$onMove = function (tag) {
	return A3(
		_elm_lang$html$Html_Events$onWithOptions,
		'mousemove',
		_mpizenberg$elm_mouse_events$Mouse$stopOptions,
...
var _mpizenberg$elm_mouse_events$Mouse$onUp = function (tag) {
	return A3(
		_elm_lang$html$Html_Events$onWithOptions,
		'mouseup',
		_mpizenberg$elm_mouse_events$Mouse$stopOptions,
...
var _user$project$Models$Model = F7(
	function (a, b, c, d, e, f, g) {
		return {radius: a, open: b, color: c, points: d, cursor: e, drawing: f, window: g};
	});
var _user$project$Models$Point = F3(
	function (a, b, c) {
		return {color: a, size: b, pos: c};
	});

var _user$project$Canvas_Easel$coords = F2(
	function (_p1, _p0) {
		var _p2 = _p1;
		var _p3 = _p0;
		return {
			ctor: '_Tuple2',
			_0: _p3._0 - (_elm_lang$core$Basics$toFloat(_p2._0) / 2),
			_1: (_elm_lang$core$Basics$toFloat(_p2._1) / 2) - _p3._1
		};
	});
var _user$project$Canvas_Easel$hex = function (code) {
	var _p4 = _eskimoblood$elm_color_extra$Color_Convert$hexToColor(code);
	if (_p4.ctor === 'Ok') {
		return _p4._0;
	} else {
...
var _user$project$Canvas_Easel$p = F2(
	function (win, point) {
		return A2(
			_evancz$elm_graphics$Collage$move,
			A2(_user$project$Canvas_Easel$coords, win, point.pos),
			_evancz$elm_graphics$Collage$filled(
				_user$project$Canvas_Easel$hex(point.color))(
				_evancz$elm_graphics$Collage$circle(point.size)));
	});
var _user$project$Canvas_Easel$c = F2(
	function (_p5, points) {
		var _p6 = _p5;
		var _p8 = _p6._0;
		var _p7 = _p6._1;
		return _evancz$elm_graphics$Element$toHtml(
			A3(
				...
				A2(
					_elm_lang$core$List$map,
					_user$project$Canvas_Easel$p(
						{ctor: '_Tuple2', _0: _p8, _1: _p7}),
					points)));
	});

var _user$project$Msgs$Stop = {ctor: 'Stop'};
var _user$project$Msgs$StopDrawing = function (a) {
	return {ctor: 'StopDrawing', _0: a};
};
var _user$project$Msgs$StartDrawing = function (a) {
	return {ctor: 'StartDrawing', _0: a};
};
var _user$project$Msgs$Track = function (a) {
	return {ctor: 'Track', _0: a};
};
var _user$project$Msgs$Resize = function (a) {
	return {ctor: 'Resize', _0: a};
};
var _user$project$Msgs$Select = function (a) {
	return {ctor: 'Select', _0: a};
};
var _user$project$Msgs$Close = {ctor: 'Close'};
var _user$project$Msgs$Open = {ctor: 'Open'};
var _user$project$Msgs$Toggle = {ctor: 'Toggle'};

var _user$project$Update$addPoint = F2(
	function (model, pos) {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			model.points,
			{
				ctor: '::',
				_0: A3(_user$project$Models$Point, model.color, model.radius, pos),
				_1: {ctor: '[]'}
			});
	});
var _user$project$Update$update = F2(
	function (msg, model) {
		...
		switch (_p0.ctor) {
			...
			case 'Track':
				var _p1 = _p0._0.clientPos;
				if (model.drawing) {
					var points = A2(_user$project$Update$addPoint, model, _p1);
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{points: points, cursor: _p1}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					return {
...
var _user$project$Utils_ToPx$toPx = function (px) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		_elm_lang$core$Basics$toString(px),
		'px');
...
var _user$project$Wheel_Wheel$absoluteCenter = {
	ctor: '::',
...
var _user$project$Wheel_Wheel$scalar = F2(
	function (radius, _p0) {
		var _p1 = _p0;
		return {ctor: '_Tuple2', _0: _p1._0 * radius, _1: _p1._1 * radius};
	});
var _user$project$Wheel_Wheel$radians = function (deg) {
	return deg * (_elm_lang$core$Basics$pi * 180);
};
var _user$project$Wheel_Wheel$degrees = F2(
	function (length, index) {
		return (360 / length) * index;
	});
var _user$project$Wheel_Wheel$position = F2(
	function (length, index) {
		var r = _user$project$Wheel_Wheel$radians(
			A2(_user$project$Wheel_Wheel$degrees, length, index));
		return {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Basics$cos(r),
			_1: _elm_lang$core$Basics$sin(r)
		};
	});
var _user$project$Wheel_Wheel$translate = function (_p2) {
	var _p3 = _p2;
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'translate3d(',
...
var _user$project$Wheel_Wheel$item = F3(
	function (size, length, _p4) {
		var _p5 = _p4;
		return A2(
			_elm_lang$html$Html$div,
			{
				...
				_0: _elm_lang$html$Html_Attributes$style(
					A2(
						_elm_lang$core$Basics_ops['++'],
						_user$project$Wheel_Wheel$absoluteCenter,
						{
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: 'transform',
								_1: _user$project$Wheel_Wheel$translate(
									A2(
										_user$project$Wheel_Wheel$scalar,
										size,
										A2(
											_user$project$Wheel_Wheel$position,
											_elm_lang$core$Basics$toFloat(length),
...
var _user$project$Wheel_Wheel$items = F2(
	function (wheel, size) {
		return A2(
			_elm_lang$core$List$map,
			A2(
				_user$project$Wheel_Wheel$item,
				size,
				_elm_lang$core$List$length(wheel)),
			A2(
...
var _user$project$Wheel_Wheel$view = F2(
	function (wheel, size) {
		return A2(
			_elm_lang$html$Html$div,
			{
					...
					A2(
						...
						_user$project$Wheel_Wheel$absoluteCenter,
						{
							...
							_0: {
								ctor: '_Tuple2',
								_0: 'height',
								_1: _user$project$Utils_ToPx$toPx(size)
							},
							_1: {
								ctor: '::',
								_0: {
			...
			A2(_user$project$Wheel_Wheel$items, wheel, size));
	});

var _user$project$View$cursor = F3(
	function (radius, color, _p0) {
		var _p1 = _p0;
		return A2(
			_elm_lang$html$Html$div,
			{
					...
					_0: _elm_lang$html$Html_Attributes$style(
						{
							...
							_1: {
								...
								_0: {
									ctor: '_Tuple2',
									_0: 'height',
									_1: _user$project$Utils_ToPx$toPx(radius * 2)
								},
								_1: {
									ctor: '::',
									_0: {
									...
									_1: {
										...
										_0: {
											ctor: '_Tuple2',
											_0: 'left',
											_1: _user$project$Utils_ToPx$toPx(_p1._0)
										},
										_1: {
											ctor: '::',
											_0: {
												ctor: '_Tuple2',
												_0: 'top',
												_1: _user$project$Utils_ToPx$toPx(_p1._1)
											},
											_1: {ctor: '[]'}
										}
									}
...
var _user$project$View$color = F2(
	function (msg, c) {
		return A2(
			_elm_lang$html$Html$div,
			{
				...
				_1: {
					...
					_1: {
						...
						_0: _elm_lang$html$Html_Attributes$style(
							{
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'backgroundColor', _1: c},
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
...
var _user$project$View$topbar = F2(
	function (msg, model) {
		return A2(
			_elm_lang$html$Html$div,
			{
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('fingerpaint'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$div,
						{
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$id('pallet'),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$style(
										{
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: 'background-color', _1: model.color},
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
...
var _user$project$View$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: A2(_user$project$View$topbar, _user$project$Msgs$Open, model),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$div,
					{
						...
						_1: {
							ctor: '::',
							_0: _mpizenberg$elm_mouse_events$Mouse$onMove(_user$project$Msgs$Track),
							_1: {
								ctor: '::',
								_0: _mpizenberg$elm_mouse_events$Mouse$onDown(_user$project$Msgs$StartDrawing),
								_1: {
									ctor: '::',
									_0: _mpizenberg$elm_mouse_events$Mouse$onUp(_user$project$Msgs$StopDrawing),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onMouseLeave(_user$project$Msgs$Stop),
										_1: {ctor: '[]'}
									}
								}
							}
					...
					{
						ctor: '::',
						_0: A2(_user$project$Canvas_Easel$c, model.window, model.points),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A3(_user$project$View$cursor, model.radius, model.color, model.cursor),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$div,
							{
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(_user$project$Msgs$Close),
										_1: {ctor: '[]'}
									}
								}
							},
							{
								ctor: '::',
								_0: A2(
									_user$project$Wheel_Wheel$view,
									A2(
										_elm_lang$core$List$map,
										_user$project$View$color(_user$project$Msgs$Select),
										_user$project$View$pallet),
									80),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
...
var _user$project$Main$subscriptions = function (model) {
	return _elm_lang$window$Window$resizes(
		function (_p0) {
			var _p1 = _p0;
			return _user$project$Msgs$Resize(
				{ctor: '_Tuple2', _0: _p1.width, _1: _p1.height});
		});
};
var _user$project$Main$windowSize = A2(
	_elm_lang$core$Task$perform,
	_user$project$Msgs$Resize,
	A3(
		_elm_lang$core$Task$map2,
		F2(
			function (v0, v1) {
		...
		_elm_lang$window$Window$height));
var _user$project$Main$init = {
	...
	_0: A7(
		...
		false,
		{ctor: '_Tuple2', _0: 0, _1: 0}),
	_1: _user$project$Main$windowSize
};
